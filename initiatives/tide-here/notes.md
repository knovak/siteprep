...
| **Add concise coverage and alternative-coast help on the page** | The README explains U.S./Canadian coverage, ordinary place versus coordinates, closest-first alternatives and source details, but a first-time visitor may not know why a nearby place offers several stations or refuses coverage. | Small | Put the explanation behind a short Help disclosure so it does not displace the forecast. Use the same supported-country and privacy wording as the live behavior, and verify it at the phone viewport. |
