...
## 2026-08-26 — Draft objectives.md - what "done" would mean

Drafted outcome-focused objectives for an extensible multi-resolution data catalogue, temporal and layered maps, projection comparison, separated 4K display controls, educational use, contributor validation, portability, and a sphere-ready boundary.
