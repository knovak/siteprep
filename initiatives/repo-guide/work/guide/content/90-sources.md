...
- [INITIATIVES_TECHDOC.md](source:INITIATIVES_TECHDOC.md) for executable lifecycle behaviour, validation, rendering, and sweep mechanics.
...
This matters because the subject here edits itself. If a summary above and a
linked file disagree, the linked file wins — and the disagreement means this
copy is old. Regenerate it before passing it on.
...
- [The technical document](source:INITIATIVES_TECHDOC.md) owns executable behaviour.
